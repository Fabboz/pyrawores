...
ITEM {
    type = "item",
    name = "casting-unit-mk03",
    icon = "__pyrawores__/graphics/icons/casting-unit-mk03.png",
    icon_size = 32,
    flags = {},
    subgroup = "py-rawores-buildings-mk03",
    order = "b",
    place_result = "casting-unit-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "casting-unit-mk03"},
    ...
    animation = {
        layers = {
            {
                filename = "__pyrawores__/graphics/entity/casting-unit-mk01/off-mk03.png",
                --priority = "high",
                width = 238,
                height = 234,
                --line_length = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyrawores__/graphics/entity/casting-unit-mk01/on-mk03.png",
                priority = "high",
                frame_count = 30,
                line_length = 6,
                width = 237,
