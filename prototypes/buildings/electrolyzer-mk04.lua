...
ITEM {
    type = "item",
    name = "electrolyzer-mk04",
    icon = "__pyrawores__/graphics/icons/electrolyzer-mk04.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyrawores__/graphics/entity/electrolyzer-mk01/off-mk04.png",
                width = 189,
                height = 192,
                --line_length = 9,
                frame_count = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyrawores__/graphics/entity/electrolyzer-mk01/on-mk04.png",
                priority = "high",
                frame_count = 60,
                line_length = 10,
                width = 160,
