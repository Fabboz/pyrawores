...
ITEM {
    type = "item",
    name = "hydroclassifier-mk04",
    icon = "__pyrawores__/graphics/icons/hydroclassifier-mk04.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyrawores__/graphics/entity/hydroclassifier-mk01/h1-mk04.png",
                --priority = "high",
                width = 96,
                height = 227,
                line_length = 21,
            ...
            {
                filename = "__pyrawores__/graphics/entity/hydroclassifier-mk01/h2-mk04.png",
                --priority = "high",
                width = 96,
                height = 227,
                line_length = 21,
            ...
            {
                filename = "__pyrawores__/graphics/entity/hydroclassifier-mk01/h3-mk04.png",
                --priority = "high",
                width = 32,
                height = 227,
                line_length = 21,
