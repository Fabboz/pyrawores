...
ITEM {
    type = "item",
    name = "wet-scrubber-mk03",
    icon = "__pyrawores__/graphics/icons/wet-scrubber-mk03.png",
    icon_size = 32,
    flags = {},
    subgroup = "py-rawores-buildings-mk03",
    order = "g",
    place_result = "wet-scrubber-mk03",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 1, result = "wet-scrubber-mk03"},
    ...
    animation = {
        layers = {
            {
                filename = "__pyrawores__/graphics/entity/wet-scrubber-mk01/wet-scrubber-base-mk03.png",
                --priority = "high",
                width = 192,
                height = 224,
                --line_length = 10,
            ...
            {
                filename = "__pyrawores__/graphics/entity/wet-scrubber-mk01/top-off-mk03.png",
                --priority = "high",
                width = 192,
                height = 128,
                --line_length = 10,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyrawores__/graphics/entity/wet-scrubber-mk01/anim-mk03.png",
                --priority = "extra-high",
                frame_count = 2,
                --line_length = 2,
                width = 192,
